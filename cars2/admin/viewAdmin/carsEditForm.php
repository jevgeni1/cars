...
?>
    <div class="alert alert-info">
        <strong>Запись изменена. </strong><a href="carsAdmin"> Список Машин</a>
    </div>
    <?php
        }
    else if($test==false)
    {
        ?>
            <div class="alert alert-warning">
                <strong>Ошибка изменения записи!</strong> <a href="carsAdmin"> Список Машин</a>
            </div>
        <?php
    }
 }
     ...
     ?>
     <form method='POST' action="carsEditResult?id=<?php echo $id; ?>" enctype="multipart/form-data">
