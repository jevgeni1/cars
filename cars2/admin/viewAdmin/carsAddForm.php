...
?>
    <div class="alert alert-info">
        <strong>Запись добавлена. </strong><a href="carsAdmin"> Список Машин</a>
    </div>
    <?php
        }
    else if($test==false)
    {
        ?>
            <div class="alert alert-warning">
                <strong>Ошибка добавлений записи!</strong> <a href="carsAdmin"> Список Машин</a>
            </div>
        <?php
    }
 }
     ...
     ?>
     <form method='POST' action="carsAddResult" enctype="multipart/form-data">
